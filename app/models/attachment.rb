class Attachment < ActiveRecord::Base
  ...
  def attachment_attributes_valid?
    ...
    errors.add_to_base("Uploaded file #{filename} has invalid content.") if attachment_options[:content_type] && !attachment_options[:content_type].include?(send(:content_type))
  end
